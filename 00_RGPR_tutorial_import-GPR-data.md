...
-   [Read/import GPR data](#read/import-gpr-data)
    -   [Sensors and software data (`.dt1`)](#sensors-and-software-data-(%60.dt1%60))
    -   [GSSI data (`.dtz`)](#gssi-data-(%60.dtz%60))
        -   [Multi-channel data](#multi-channel-data)
    -   [MALA data (`.rd3`, `.dr7`)](#mala-data-(%60.rd3%60,-%60.dr7%60))
    -   [ImpulseRadar data (`.iprb`)](#impulseradar-data-(%60.iprb%60))
    -   [SEG-Y data (`.sgy`)](#seg-y-data-(%60.sgy%60))
    -   [RadSys Zond GPR data (`.segy`)](#radsys-zond-gpr-data-(%60.segy%60))
    -   [Geomatrix Earth Science data (`.dat`)](#geomatrix-earth-science-data-(%60.dat%60))
    -   [ASCII data (`.txt`)](#ascii-data-(%60.txt%60))
    -   [ENVI band-sequential files (`.dat`, `.hdr`)](#envi-band-sequential-files-(%60.dat%60,-%60.hdr%60))
    -   [Pickle files (`.pkl`, serialized Python object)](#pickle-files-(%60.pkl%60,-serialized-python-object))
