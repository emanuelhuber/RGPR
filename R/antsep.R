...
#' Modified slots
#' \itemize{
#'   \item `antsep` the antenna separation distance
#'   \item `x` the x-position only for CMP/WARR (plot twt as a function of antenna separation)
#' }
#' @param x (`GPR`) An object of the class GPR.
#' @param value (`numeric[1]|numeric[m]`)
#' @return (`GPR`) 
#' @name antsep
#' @rdname antsep
