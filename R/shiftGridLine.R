...
#' @export
setGeneric("shiftGridLine", function(obj, i, dx = 0, dy = 0, dz = 0){ 
...
#' @param obj (`GPRsurvey`) Index of the line to be shifted
...
#' @rdname shiftGridLine
#' @export
setMethod("shiftGridLine", "GPRsurvey", function(obj, i, dx = 0, dy = 0, dz = 0){
  ...
  if(is.numeric(i)){
    obj@coords[[i]] <- t(t(obj@coords[[i]]) + c(dx, dy , dz))
