...
#' 
#' @param twt (`numeric[n]`) $n$ two-way travel times ($n > 0$)
#' @param v   [`numeric[n]`] $n$ corresponding velocities
#' @return (`list`) List with two elements: `t` (time) and
#'         `v` (corresponding Dix velocities)
#' @export
